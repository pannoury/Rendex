...
function cityWindowScript(regionValue){
    ...
    if(regionValue === 'västra götaland'){
        ...
        else if(citySelected.isArray === false){

        }
        else if(citySelected.isArray === true){
        ...
        if(document.getElementById(regionValueChechbox).checked === true){
